...
$(document).ready(function () {
  ...
  // Function to fetch and display movies in the "Now Playing" section
  function fetchAndDisplayMovies(nowplaying) {
    // URL for the API request to get the currently playing movies
    ...
    fetch(apiUrl)
      ...
      .then(function (data) {
        ...
        if (data.results.length > 0) {
          ...
          // Replace the content of the "Now Playing" element with the movies container
      ...
      .catch(function (err) {
        ...
        if (err.message === "Movies not found") {
          // Replace the content of the "Now Playing" element with an error message
          nowplaying.html("No movies found.");
        } else {
          // Handle other errors
        }
  ...
  // Call the fetchAndDisplayMovies function when the page loads, passing the .nowplaying-movies element
  fetchAndDisplayMovies(nowplayingEl);
});